...
namespace huang {
#define BPLUSTREE_TYPE BPlusTree<class KeyType,class ValueType,class KeyComparator>
#define INDEX_TEMPLATE_ARGUMENTS template <class KeyType, class ValueType, class KeyComparator>
